...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`students` (`students_id`, `vards`, `uzvards`, `klase`, `epasts`, `parole`, `skolas_id`) VALUES (DEFAULT, 'Kārlis', 'Lācītis', '1.kurss', 'lacitis18@inbox.lv', 'parole', 3);
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`skolotajs` (`skolotajs_id`, `vards`, `uzvards`, `epasts`, `parole`) VALUES (DEFAULT, 'Tests', 'Testētājs', 'lacitiskarlis@gmail.com', 'parole');
