...
const TeacherEditDrawer = ({
  ...
  useEffect(() => {
    if (teacher) {
      setFormData({
        vards: teacher.vards || '',
        uzvards: teacher.uzvards || '',
        epasts: teacher.epasts || '',
        parole: '',
        paroleAtk: '',
      })
    }
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      await axios.patch(`lietotajs/single/${teacher.lietotajs_id}`, {
      ...
      updateTeacherInList(teacher.skolotajs_id, {
        vards: formData.vards,
        uzvards: formData.uzvards,
        epasts: formData.epasts,
      })
    ...
    >
      ...
      >
        <Box
          ...
          mb={2}
        >
          <Typography variant='h6'>Rediģēt skolotāju</Typography>
